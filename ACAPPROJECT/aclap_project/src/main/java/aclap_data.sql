...
INSERT INTO MYSTAMP VALUES (SEQ_MYSTAMP.NEXTVAL, 8, 3, '요리', '양식', '양식배우기');

INSERT INTO MYSTAMP VALUES (SEQ_MYSTAMP.NEXTVAL, 8, 4, '요리', '양식', '양식배우기');

INSERT INTO MYSTAMP VALUES (SEQ_MYSTAMP.NEXTVAL, 8, 2, '요리', '양식', '양식배우기');
...
INSERT INTO MYSTAMP VALUES (SEQ_MYSTAMP.NEXTVAL, 8, 1, '요리', '양식', '양식배우기');
...
WHERE MEMNUM = #{memNum} AND 
	RNUM&gt;=1+10*#{ pagenumber } AND RNUM&lt;=10+10*#{ pagenumber }
